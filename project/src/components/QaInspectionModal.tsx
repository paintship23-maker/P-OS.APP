...
import { X, ClipboardCheck, Camera, CheckCircle2, AlertCircle } from 'lucide-react';
...
export function QaInspectionModal({
  ...
  const handleApprove = () => {
    ...
    onApprove({ checklist, beforePhotoUrl: beforePhotoUrl.trim(), afterPhotoUrl: afterPhotoUrl.trim() });
  };
