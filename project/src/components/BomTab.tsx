  ...
  return (
    <div className="space-y-4 animate-fade-in">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
        <BannerStat icon={<Package size={16} />} label="Total Items" value={String(materials.length)} color="brand" />
        <BannerStat icon={<Package size={16} />} label="Total Required" value={fmtNum(summary.totalRequired)} color="slate" />
        <BannerStat icon={<Truck size={16} />} label="Ordered" value={fmtNum(summary.totalOrdered)} color="amber" />
        <BannerStat icon={<CheckCircle2 size={16} />} label="Delivered" value={fmtNum(summary.totalDelivered)} color="emerald" />
        <BannerStat icon={<Store size={16} />} label="Pending Order" value={String(summary.pendingOrderCount)} color="slate" />
        <BannerStat icon={<Truck size={16} />} label="In Transit" value={String(summary.orderedCount)} color="amber" />
      </div>
  ...
  return (
    <tr className="transition-colors hover:bg-slate-50 dark:hover:bg-slate-800/50">
      <td className="px-4 py-3">
        <p className="font-medium text-slate-700 dark:text-slate-200">{material.name}</p>
        {material.category && (
        ...
        <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4 dark:border-slate-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">{material.name}</p>
            </div>
          </div>
