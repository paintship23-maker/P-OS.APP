...
import type { PaintProject, Supervisor } from '@/types';
...
export function SupervisorsTab({ supervisors, project, onSetLeadSupervisor }: SupervisorsTabProps) {
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  disabled={isLead}
                  className={`mt-4 flex w-full items-center justify-center gap-1.5 rounded-lg py-2.5 text-xs font-semibold transition-all active:scale-[0.98] ${
                    isLead
